...
public:
    ...
    static const QString ShieldReceive; /**< Specifies shield send address */
    static const QString ShieldSend; /**< Specifies shield receive address */
     ...
     */
    QString getAddressToShow(bool shield = false) const;
