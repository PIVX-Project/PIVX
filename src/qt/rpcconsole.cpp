                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSYNXPathCustom = GetArg("-zsynxbackuppath", "");
    ...
    if(!strzSYNXPathCustom.empty()) {
        ui->wallet_customzsynxbackuppath->setText(QString::fromStdString(strzSYNXPathCustom));
        ui->wallet_customzsynxbackuppath_label->setVisible(true);
        ui->wallet_customzsynxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSYNXPathCustom.empty()) && nCustomBackupThreshold > 0) {
