...
QT_TRANSLATE_NOOP("darknet-core", "(must be 51472 for mainnet)"),
...
QT_TRANSLATE_NOOP("darknet-core", "Copyright (C) 2014-%i The Dash Core Developers"),
QT_TRANSLATE_NOOP("darknet-core", "Copyright (C) 2015-%i The DARKNET Core Developers"),
...
QT_TRANSLATE_NOOP("darknet-core", "Fee (in PIV/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("darknet-core", "Invalid amount for -reservebalance=<amount>"),
...
QT_TRANSLATE_NOOP("darknet-core", "Keep N PIV anonymized (default: %u)"),
