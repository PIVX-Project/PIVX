...
/* Vpx GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "VPX"
#define QAPP_ORG_DOMAIN "vpx.org"
#define QAPP_APP_NAME_DEFAULT "VPX-Qt"
#define QAPP_APP_NAME_TESTNET "VPX-Qt-testnet"
