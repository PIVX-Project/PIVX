 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Syndicate (http://synx.online),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (mapArgs.count("-version")) {
            ...
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  syndicated [options]                     " + _("Start Pivx Core Daemon") + "\n";
