...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"syndicate", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"syndicate", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"syndicate", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        ...
        {"zerocoin", "getzsynxseed", &getzsynxseed, false, false, true},
        {"zerocoin", "setzsynxseed", &setzsynxseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsynx", &searchdzsynx, false, false, true},
        {"zerocoin", "dzsynxstate", &dzsynxstate, false, false, true}
