...
public:
	...
	hashGenesisBlock = genesis.GetHash();
        ...
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80000013).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >(); // Testnet darknet BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >(); // Testnet darknet BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80000001).convert_to_container<std::vector<unsigned char> >();             // Testnet darknet BIP44 coin type is '5' (All coin's testnet default)
