...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the SYNX and zSYNX money supply statistics") + " " + _("on startup"));
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all Syndicate specific functionality (Masternodes, Zerocoin, SwiftX, Budgeting) (0-1, default: %u)"), 0));

#ifdef ENABLE_WALLET
    strUsage += HelpMessageGroup(_("Staking options:"));
    strUsage += HelpMessageOpt("-staking=<n>", strprintf(_("Enable staking functionality (0-1, default: %u)"), 1));
    strUsage += HelpMessageOpt("-synxstake=<n>", strprintf(_("Enable or disable staking functionality for SYNX inputs (0-1, default: %u)"), 1));
    strUsage += HelpMessageOpt("-zsynxstake=<n>", strprintf(_("Enable or disable staking functionality for zSYNX inputs (0-1, default: %u)"), 1));
    ...
    strUsage += HelpMessageOpt("-backupzsynx=<n>", strprintf(_("Enable automatic wallet backups triggered after each zSYNX minting (0-1, default: %u)"), 1));
    strUsage += HelpMessageOpt("-zsynxbackuppath=<dir|file>", _("Specify custom backup path to add a copy of any automatic zSYNX backup. If set as dir, every backup generates a timestamped file. If set as file, will rewrite to that file every backup. If backuppath is set as well, 4 backups will happen"));
#endif // ENABLE_WALLET
...
// ********************************************************* Step 5: Backup wallet and verify wallet database integrity
    ...
    //Syndicate: Load Accumulator Checkpoints according to network (main/test/regtest)
...
// ********************************************************* Step 8: load wallet
    ...
    if (fDisableWallet) {
        ...
        zwalletMain = new CzSYNXWallet(pwalletMain->strWalletFile);
