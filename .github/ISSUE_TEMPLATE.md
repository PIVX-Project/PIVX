...
This issue tracker is only for technical issues related to DARKNET Core.
General DARKNET questions and/or support requests and are best directed to the [DARKNET Slack](http://darknet.slack.com).
...
### What version of DARKNET Core are you using?
