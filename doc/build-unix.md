UNIX BUILD NOTES
====================
Some notes on how to build DARKNET in Unix.
...
memory available when compiling DARKNET Core. With 512MB of memory or less
...
If you want to build DARKNET-Qt, make sure that the required packages for Qt development
...
Security
--------
To help make your DARKNET installation more secure by making certain attacks impossible to
