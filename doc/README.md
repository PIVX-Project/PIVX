...
Setup
---------------------
[DARKNET Core](http://darknet.org/wallet) is the original DARKNET client and it builds the backbone of the network. However, it downloads and stores the entire history of DARKNET transactions; depending on the speed of your computer and network connection, the synchronization process can take anywhere from a few hours to a day or more. Thankfully you only have to do this once.
...
* Ask for help on [BitcoinTalk](https://bitcointalk.org/index.php?topic=1262920.0) or on the [DARKNET Forum](http://forum.darknet.org/).
* Join one of our Slack groups [DARKNET Slack Groups](https://darknet.org/slack-logins/).
...
* Discuss on the [BitcoinTalk](https://bitcointalk.org/index.php?topic=1262920.0) or the [DARKNET](http://forum.darknet.org/) forum.
* Join the [DARKNET-Dev](https://darknet-dev.slack.com/) Slack group ([Sign-Up](https://darknet-dev.herokuapp.com/)).
