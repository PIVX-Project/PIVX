...
Only requiring some minor changes is vpx.cpp.
...
Changes to vpx.cpp
----------------------
vpx.cpp is the entry point into privix-qt, and as such, will require some minor modifications to provide hooks for
