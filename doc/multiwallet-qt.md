...
In order to support loading of multiple wallets in darknet-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is darknet.cpp.
...
Changes to darknet.cpp
----------------------
darknet.cpp is the entry point into darknet-qt, and as such, will require some minor modifications to provide hooks for
