...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ DARKNET, _12_ times over the course of a year totaling _24000_ DARKNET.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<darknet_address\> \<monthly_payment_darknet\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` DARKNET.
