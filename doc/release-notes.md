DARKNET Core version 2.2.1 is now available from:

  <https://github.com/darknetpay/darknet/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/darknetpay/darknet/issues>

Compatibility
==============

DARKNET Core is extensively tested on multiple operating systems using
...
DARKNET Core should also work on most other Unix-like systems but is not
...
of Bitcoin that DARKNET was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/darknet-project-translations/).
