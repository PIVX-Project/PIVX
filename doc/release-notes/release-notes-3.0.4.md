VPX Core version 3.0.4 is now available from:
...
VPX Core v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zVPX protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
---------------------
The stake miner code now filters out zVpx double spends that were on rare occasions being slipped into blocks (and being rejected by peers when broadcast to the network).
...
More Extensive Display of zVpx Confirmation/Maturity Status
---------------------
Within the Privacy Dialog of the QT wallet, the _Zerocoin Stats_ section now displays both the confirmation and maturity status of minted zVpx's. Previously this was only able to be viewed within the zVpx Control dialog. The main Overview tab of the QT wallet now splits zVpx balance into subcategories: _Unconfirmed_, _Immature_, and _Mature_.
...
- #328 `a6c18c8` [Main] VPX not responding on user quitting app (Aaron Langford)
