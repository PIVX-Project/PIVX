...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/SyndicateLtd/SyndicateQt/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/SyndicateLtd/gitian.sigs.git
    git clone https://github.com/SyndicateLtd/syndicate-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/SyndicateLtd/SyndicateQt.git
...
space *do not upload these to the synx.online server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/SyndicateLtd/SyndicateQt/releases/new) with a link to the archived release notes.
