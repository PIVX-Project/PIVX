Contributing to VPX Core
============================

The VPX Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the vpx unit tests or QA tests
...
The following applies to code changes to the VPX Core project, and is not to be
confused with overall VPX Network Protocol consensus changes.

Whether a pull request is merged into VPX Core rests with the project merge
...
Patches that change VPX consensus rules are considerably more involved than
...
Where a patch set proposes to change the VPX consensus, it must have been
...
The project leader is the release manager for each VPX Core release.
