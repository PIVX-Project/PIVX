Contributing to DARKNET Core
============================

The DARKNET Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DARKNET Core project, and is not to be
confused with overall DARKNET Network Protocol consensus changes.

Whether a pull request is merged into DARKNET Core rests with the project merge
...
Patches that change DARKNET consensus rules are considerably more involved than
...
Where a patch set proposes to change the DARKNET consensus, it must have been
...
The project leader is the release manager for each DARKNET Core release.
