...
This means one can have an always-on syndicated instance running, and another local syndicated/pivx-qt instance which connects to this node and receives blocks from it.
