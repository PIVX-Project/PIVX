...
RESOURCES += src/qt/vpx.qrc src/qt/vpx_locale.qrc

TRANSLATIONS += src/qt/locale/vpx_bg.ts \
                src/qt/locale/vpx_de.ts \
                src/qt/locale/vpx_en.ts \
                src/qt/locale/vpx_es.ts \
                src/qt/locale/vpx_fi.ts \
                src/qt/locale/vpx_fr.ts \
                src/qt/locale/vpx_it.ts \
                src/qt/locale/vpx_ja.ts \
                src/qt/locale/vpx_pl.ts \
                src/qt/locale/vpx_pt.ts \
                src/qt/locale/vpx_ru.ts \
                src/qt/locale/vpx_sk.ts \
                src/qt/locale/vpx_sv.ts \
                src/qt/locale/vpx_vi.ts \
                src/qt/locale/vpx_zh_CN.ts \
                src/qt/locale/vpx_zh_TW.ts
